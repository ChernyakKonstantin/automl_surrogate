...
#     ) -> Tensor:
#         pipe1, pipe2, pipe3, pipe4, pipe5, y = batch
#         node_embedding1 = self.node_embedder(pipe1)
#         node_embedding2 = self.node_embedder(pipe2)
#         node_embedding3 = self.node_embedder(pipe3)
#         node_embedding4 = self.node_embedder(pipe4)
#         node_embedding5 = self.node_embedder(pipe5)
...
#         x_pipe3 = pipe3.to_pyg_batch(self.node_embedder.out_dim, node_embedding3)
#         x_pipe4 = pipe4.to_pyg_batch(self.node_embedder.out_dim, node_embedding4)
#         x_pipe5 = pipe5.to_pyg_batch(self.node_embedder.out_dim, node_embedding5)

#         pred1 = self.forward(x_pipe1)
#         pred2 = self.forward(x_pipe2)
#         pred3 = self.forward(x_pipe3)
#         pred4 = self.forward(x_pipe4)
#         pred5 = self.forward(x_pipe5)

#         pred = torch.hstack([pred1, pred2, pred3, pred4, pred5])

#         loss = nn.functional.cross_entropy(pred, y, label_smoothing=0.3)
